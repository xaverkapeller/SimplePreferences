 ...
 */
class FloatGetterExecutableBuilderImpl extends ExecutableBuilder {
    ...
    public FloatGetterExecutableBuilderImpl(ProcessingEnvironment processingEnvironment, ExecutableElement method, Field fieldPreferences, String key) {
    ...
    protected void write(Block block) {
        if (Utils.hasOneAnnotationOf(mMethod, FLOAT_BLACKLIST)) {
