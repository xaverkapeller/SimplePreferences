...
public class ClassBuilder {
    ...
    public Method addMethod(Type returnType, String name, Set<Modifier> modifiers, Set<Variable> parameters) {
    ...
    public Method addMethod(Type returnType, String name, Set<Modifier> modifiers, ExecutableBuilder builder) {
        ...
        final Set<Variable> parameters = builder.createParameterSet(generator);
        final MethodImpl method = new MethodImpl(returnType, name, parameters, modifiers);
        mMethods.add(method);
    ...
    public Constructor addConstructor(Set<Modifier> modifiers, Set<Variable> parameters) {
    ...
    public Type build() throws IOException {
        ...
        for (ConstructorImpl constructor : mConstructors) {
            ...
            final Variable[] parameters = constructor.parameters().toArray(new Variable[constructor.parameters().size()]);

            final String[] parameterArray = new String[parameters.length * 2];
        ...
        for(MethodImpl method : mMethods) {
            ...
            final Variable[] parameters = method.parameters().toArray(new Variable[method.parameters().size()]);
